	...
	<div class="search-messages">
		<div class="search-messages__input">
			<input v-model="query"
				...
				:placeholder="t('mail', 'Search input')"
				:aria-label="t('mail', 'Search input')"
			...
			<NcButton type="tertiary" class="search-messages--filter" @click="moreSearchActions = true">
				<template #icon>
					<FilterVariantPointsIcon :size="20" />
				</template>
			</NcButton>
			...
			<NcDialog v-if="moreSearchActions"
				...
				<div class="modal-inner--content">
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<input id="subjectId"
								...
								type="text"
								class="search-input"
								:placeholder="t('mail', 'Search subject new')">
						</div>
					</div>
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<input id="bodyId"
								...
								type="text"
								class="search-input"
								:placeholder="t('mail', 'Search body new')">
						</div>
					</div>
					<div class="modal-inner--field">
					...
					<div class="modal-inner--field" style="display: none">
					...
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container marked-as">
							...
							<div class="modal-inner-inline" style="display: none">
								<NcCheckboxRadioSwitch :checked.sync="searchFlags"
									value="attachments"
									name="flags[]"
									type="checkbox">
...
import FilterVariantPointsIcon from '../components/icons/FilterVariantPointsIcon.vue'
