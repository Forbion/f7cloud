OC.L10N.register(
    ...
    "Create alias" : "Создать",
    "Cancel" : "Отмена",
    "Mail settings" : "Параметры эл. почты",
    "Accounts" : "Учётные записи",
    "Add mail account" : "Добавить учетную запись",
    ...
    "Write message new …" : "Напишите что-нибудь",
    ...
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Редактировать {number} теги", "Редактировать {number} теги"],
    "_Mark {number} as spam_::_Mark {number} as spam_" : ["Отправить {number} в спам", "Отправить {number} в спам"],
    "_Delete {number} thread_::_Delete {number} threads_" : ["Удалить {number} ветку", "Удалить {number} ветки"],
    ...
    "Autoresponder off" : "Выключить",
    "Autoresponder on" : "Включить",
    ...
    "Search subject new" : "Выберите тему",
    "Body" : "Тело",
    "Date" : "Дата",
    ...
    "Add default tags" : "Изменить метки",
    ...
    "All" : "Все",
    "Please choose a date": "Выберите дату",
    "Set custom snooze": "Установить выбранное время",
    "Repair mailbox": "Перезагрузить модуль почты",
    "Drafts" : "Черновики",
    "Favorites" : "Избранные",
