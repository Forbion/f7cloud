...
var render = function render() {
  ...
  return _c("AppSettingsDialog", {
  ...
  }) : _c("p", [_vm._v("\n\t\t\t" + _vm._s(_vm.t("mail", "Please connect to a sieve server first.")) + "\n\t\t")])], 1) : _vm._e(), _vm._v(" "), _vm.account && _vm.account.sieveEnabled ? _c("AppSettingsSection", {
    attrs: {
      id: "mail-filters",
      name: _vm.t("mail", "Filters")
    }
  }, [_c("div", {
    attrs: {
      id: "mail-filters"
    ...
    attrs: {
      id: "sieve-filter",
      name: _vm.t("mail", "Sieve script editor")
    }
  }, [_c("div", {
    attrs: {
      id: "sieve-filter"
...
//# sourceMappingURL=mail.account-settings.4f96e38c08bb8077033f.js.map