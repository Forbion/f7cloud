...
<template>
	<div class="footer-bar bar"
		:class="{
			'footer-bar--sidebar': isSidebar,
			'footer-bar--in-call': isInCall,
			'footer-bar--authorised': getUserId,
			'sidebar--opened': this.sidebarStore.show
		}">
...
<!--        :hide-favorite="false"-->
<!--        :hide-call="false" />-->
<!--      &lt;!&ndash; conversation header &ndash;&gt;-->
<!--      <a role="button"-->
...
<!--    <div class="top-bar-outer-white-block"></div>-->
    <div class="footer-bar__wrapper" :data-theme-dark="isInCall">
