...
/* harmony import */ var _utils_requestRoomSelection_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/requestRoomSelection.js */ "./src/utils/requestRoomSelection.js");
...
window.OCP.Collaboration.registerType("room", {
  action: async () => {
    const conversation = await (0,_utils_requestRoomSelection_js__WEBPACK_IMPORTED_MODULE_2__.requestRoomSelection)("spreed-room-select", {});
    if (!conversation) {
      throw new Error("User cancelled resource selection");
    }
    return conversation.token;
  },
  typeString: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)("spreed", "Link to a conversation"),
...
/******/ })()
;
//# sourceMappingURL=talk-collections.js.map?v=1e8987adf402dba61f99