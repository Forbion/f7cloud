...
/* harmony import */ var _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-DEeHBxbo.mjs */ "./node_modules/@nextcloud/upload/dist/chunks/index-DEeHBxbo.mjs");
...
var __component__$5 = /* @__PURE__ */ (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$5,
  _sfc_render$5,
...
var __component__$4 = /* @__PURE__ */ (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$4,
  _sfc_render$4,
...
var __component__$3 = /* @__PURE__ */ (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$3,
  _sfc_render$3,
...
var __component__$2 = /* @__PURE__ */ (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$2,
  _sfc_render$2,
...
const _sfc_main$1 = (0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  computed: {
    ...
    incomingSize() {
      if (!this.incomingFile) {
        return (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("Unknown size");
      }
  ...
  watch: {
    ...
    incoming: {
      ...
      async handler() {
        ...
        } else if ((0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.a)(this.incoming)) {
  ...
  methods: {
    ...
    isFolder(node) {
      if ((0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(node)) {
    ...
    t: _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t
  }
});
...
var __component__$1 = /* @__PURE__ */ (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$1,
  _sfc_render$1,
...
const _sfc_main = (0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  setup() {
    return {
      blockedTitle: (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("You need to select at least one version of each file to continue.")
    };
  },
  data() {
    return {
  ...
  computed: {
    name() {
      if (this?.dirname?.trim?.() !== "") {
        return (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.b)("{count} file conflict in {dirname}", "{count} file conflicts in {dirname}", this.conflicts.length, {
          count: this.conflicts.length,
          dirname: this.dirname
        });
      }
      return (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.b)("{count} file conflict", "{count} files conflict", this.conflicts.length, { count: this.conflicts.length });
    },
    skipButtonLabel() {
      if (this.conflicts.length === 1) {
        return (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("Skip this file");
      }
      return (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.b)("Skip {count} file", "Skip {count} files", this.conflicts.length, { count: this.conflicts.length });
    },
  ...
  mounted() {
    this.files = this.conflicts.map((conflict) => {
      const name = conflict instanceof File || (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(conflict) ? conflict.name : conflict.basename;
    ...
    _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("ConflictPicker initialised", { files: this.files, conflicts: this.conflicts, content: this.content });
  },
  methods: {
    onCancel(error) {
      this.opened = false;
    ...
    onSkip() {
      _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Conflict skipped. Ignoring all conflicting files");
      this.opened = false;
      this.$emit("submit", {
        selected: [],
        renamed: []
    ...
    onSubmit() {
      ...
      const toRename = this.newSelected.filter((node) => {
        const name = node instanceof File || (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(node) ? node.name : node.basename;
        return selectedOldNames.includes(name);
      });
      if (toRename.length > 0) {
        toRename.forEach((file) => {
          const name = file instanceof File || (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(file) ? file.name : file.basename;
          const newName = (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.getUniqueName)(name, directoryContent);
          if (file instanceof File || (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(file)) {
      ...
      _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Conflict resolved", { selected, renamed });
      this.opened = false;
      this.$emit("submit", {
        selected,
        renamed
    ...
    onSelectAllNew(selected) {
      if (selected) {
        _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Selected all new files");
        this.newSelected = this.conflicts;
      } else {
        _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Cleared new selection");
        this.newSelected = [];
      }
    },
    onSelectAllOld(selected) {
      if (selected) {
        _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Selected all existing files");
        this.oldSelected = this.files;
      } else {
        _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Cleared old selection");
        this.oldSelected = [];
      }
    },
    t: _index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.t
...
var __component__ = /* @__PURE__ */ (0,_index_DEeHBxbo_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main,
  _sfc_render,
...
/* harmony import */ var _chunks_l10n_BEfeU7gr_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../chunks/_l10n-BEfeU7gr.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/_l10n-BEfeU7gr.mjs");




(0,_chunks_l10n_BEfeU7gr_mjs__WEBPACK_IMPORTED_MODULE_1__.r)(_chunks_l10n_BEfeU7gr_mjs__WEBPACK_IMPORTED_MODULE_1__.e);
const FEW_SECONDS_AGO = {
  long: (0,_chunks_l10n_BEfeU7gr_mjs__WEBPACK_IMPORTED_MODULE_1__.a)("a few seconds ago"),
  short: (0,_chunks_l10n_BEfeU7gr_mjs__WEBPACK_IMPORTED_MODULE_1__.a)("seconds ago"),
  // FOR TRANSLATORS: Shorter version of 'a few seconds ago'
  narrow: (0,_chunks_l10n_BEfeU7gr_mjs__WEBPACK_IMPORTED_MODULE_1__.a)("sec. ago")
  // FOR TRANSLATORS: If possible in your language an even shorter version of 'a few seconds ago'
};
function useFormatRelativeTime(timestamp = Date.now(), opts = {}) {
  let timeoutId;
  const date = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => new Date((0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(timestamp)));
  const options = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => {
    const { language, relativeTime: relativeTime2, ignoreSeconds } = (0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(opts);
    return {
      ...language && { language },
  ...
  function updateRelativeTime() {
    ...
    if ((0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(opts).update !== false) {
      const diff = Math.abs(Date.now() - new Date((0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(timestamp)).getTime());
...
function useFormatTime(timestamp, opts) {
  const options = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => ({
    ...
    ...(0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(opts)
  }));
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => formatter.value.format((0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(timestamp)));
}
function useFormatDateTime(timestamp = Date.now(), opts = {}) {
  ...
  const relativeTime = useFormatRelativeTime(timestamp, (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => {
    const options = (0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(opts);
    return {
      ...options,
      relativeTime: typeof options.relativeTime === "string" ? options.relativeTime : "long"
    };
  }));
  const formattedTime = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => (0,_vueuse_core__WEBPACK_IMPORTED_MODULE_3__.toValue)(opts).relativeTime !== false ? relativeTime.value : formattedFullTime.value);
  return {
    formattedTime,
    formattedFullTime
  };
...
/* harmony export */ });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _Composables_useFormatDateTime_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Composables/useFormatDateTime.mjs */ "./node_modules/@nextcloud/vue/dist/Composables/useFormatDateTime.mjs");
...
const _sfc_main = {
  ...
  setup(props) {
    const timeOptions = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => ({ format: props.format }));
    const relativeTimeOptions = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => ({
      ignoreSeconds: props.ignoreSeconds,
      relativeTime: props.relativeTime || "long",
      update: props.relativeTime !== false
    }));
    const title = (0,_Composables_useFormatDateTime_mjs__WEBPACK_IMPORTED_MODULE_0__.useFormatTime)((0,vue__WEBPACK_IMPORTED_MODULE_2__.toRef)(props, "timestamp"), timeOptions);
    const relativeTime = (0,_Composables_useFormatDateTime_mjs__WEBPACK_IMPORTED_MODULE_0__.useFormatRelativeTime)((0,vue__WEBPACK_IMPORTED_MODULE_2__.toRef)(props, "timestamp"), relativeTimeOptions);
    const formattedTime = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => props.relativeTime ? relativeTime.value : title.value);
    return {
      formattedTime,
      title
    };
