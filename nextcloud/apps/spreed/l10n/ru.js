OC.L10N.register(
    ...
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in a the conversation @all or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Пусть разговоры идут своим чередом: упоминайте пользователей, реагируйте на сообщения и многое другое\n\nВы можете упомянуть всех участников обсуждения «@all» или конкретных участников, набрав «@» и выбрав имя из списка.",
    ...
    "Enable Federation in Talk app" : "Включить Федерацию в Конференциях",
    ...
    "Share from {nextcloud}" : "Опубликовать из F7",
    "Share from Files" : "Опубликовать из F7",
    ...
    "Add answer" : "Добавить больше ответов",
    "Settings" : "Настройки",
    "Anonymous poll" : "Закрытый опрос",
    ...
    "Join a conversation or start a new one" : "Выберите чат и начните общение",
    ...
    "- Calls can now be recorded (requires the external signaling server)" : "- Вызовы теперь можно записывать (требуется внешний сигнальный сервер)",
