(function (global, factory) {
            ...
            if (typeof listener === 'function') {
              if (type === 'dataavailable') {
                ...
                patchedEventListener = function patchedEventListener(event) {
                  var _flags$ = flags[0],
                    _flags$2 = _flags$ === undefined ? [false, false] : _flags$,
    ...
    var createWebAudioMediaRecorderFactory = function createWebAudioMediaRecorderFactory(createBlobEvent, createInvalidModificationError, createInvalidStateError, createNotSupportedError) {
      return function (eventTarget, mediaStream, mimeType) {
        var _a;
        var sampleRate = (_a = mediaStream.getAudioTracks()[0]) === null || _a === undefined ? undefined : _a.getSettings().sampleRate;
        ...
        return {
          ...
          start: function start(timeslice) {
            ...
            var channelCount = audioTracks.length === 0 ? 2 : (_a = audioTracks[0].getSettings().channelCount) !== null && _a !== undefined ? _a : 2;
                ...
                promisedDataViewElementTypeEncoderInstanceIdAndPort = promisedDataViewElementTypeEncoderInstanceIdAndPort.then(/*#__PURE__*/function () {
                  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee2(_ref3) {
                    ...
                    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) switch (_context2.prev = _context2.next) {
                        case 0:
                          _ref3$dataView = _ref3.dataView, dataView = _ref3$dataView === undefined ? null : _ref3$dataView, _ref3$elementType = _ref3.elementType, elementType = _ref3$elementType === undefined ? null : _ref3$elementType, encoderInstanceId = _ref3.encoderInstanceId, port = _ref3.port;
                          _context2.next = 3;
