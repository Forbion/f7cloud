...
const _pluginVue2_normalizer = require("./chunks/_plugin-vue2_normalizer-CIZhSBR-.cjs");
...
class FilePicker {
   ...
   */
  async pick() {
    const { FilePickerVue } = await Promise.resolve().then(() => require("./chunks/index-DKFJwu2b.cjs"));
