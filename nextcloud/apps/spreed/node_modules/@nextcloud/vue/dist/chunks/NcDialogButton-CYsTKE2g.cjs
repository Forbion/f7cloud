...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    return { __sfc: true, props, emit, isLoading, handleClick, t: _l10n.t, NcButton: Components_NcButton, NcIconSvgWrapper: NcIconSvgWrapper.NcIconSvgWrapper, NcLoadingIcon: Components_NcLoadingIcon };
  }
};
...
//# sourceMappingURL=NcDialogButton-CYsTKE2g.cjs.map
