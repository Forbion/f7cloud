require('../assets/NcRichContenteditable-DoDTb8p_.css');
"use strict";
const _l10n = require("./_l10n-ICucobx3.cjs");
const getAvatarUrl = require("./getAvatarUrl-6z9qRNH-.cjs");
const NcUserStatusIcon = require("./NcUserStatusIcon-BKwkHHPs.cjs");
...
require("./NcRichText-B1WT1pJp.cjs");
require("./index-BV85rPB7.cjs");
require("@vueuse/core");
require("vue");
require("vue-router");
const referencePickerModal = require("./referencePickerModal-C3zq9N4N.cjs");
...
require("./NcSelect-B7KNWVHM.cjs");
require("../Components/NcLoadingIcon.cjs");
require("./NcTextField-BUAXFTZf.cjs");
