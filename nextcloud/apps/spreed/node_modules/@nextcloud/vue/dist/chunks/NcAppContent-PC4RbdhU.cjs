require('../assets/NcAppContent-JfRwJlWK.css');
"use strict";
...
const rtl = require("./rtl-DLuwcTlm.cjs");
...
var _sfc_render$1 = function render() {
  ...
  return _c("NcButton", { directives: [{ name: "tooltip", rawName: "v-tooltip", value: _vm.title, expression: "title" }], staticClass: "app-details-toggle", class: { "app-details-toggle--mobile": _vm.isMobile }, attrs: { "aria-label": _vm.title, "variant": "tertiary" }, scopedSlots: _vm._u([{ key: "icon", fn: function() {
...
const { name: productName } = initialState.loadState("theming", "data", { name: "Nextcloud" });
const activeApp = initialState.loadState("core", "active-app", appName);
const localizedAppName = initialState.loadState("core", "apps", {})[activeApp]?.name ?? appName;
const _sfc_main = {
  name: "NcAppContent",
  components: {
    NcAppDetailsToggle,
...
//# sourceMappingURL=NcAppContent-PC4RbdhU.cjs.map
