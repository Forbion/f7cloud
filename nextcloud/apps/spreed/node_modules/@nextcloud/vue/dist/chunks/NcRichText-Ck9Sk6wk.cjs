require('../assets/NcRichText-BwghUUnz.css');
"use strict";
...
const NcCheckboxRadioSwitch = require("./NcCheckboxRadioSwitch-DOxX6fqr.cjs");
...
const _sfc_main = {
  ...
  methods: {
    ...
    renderMarkdown(h) {
      ...
      }).use(remarkUnescape).use(this.useExtendedMarkdown ? remarkGfm : void 0).use(breaks__default.default).use(remark2rehype__default.default, {
        handlers: {
...
//# sourceMappingURL=NcRichText-Ck9Sk6wk.cjs.map
