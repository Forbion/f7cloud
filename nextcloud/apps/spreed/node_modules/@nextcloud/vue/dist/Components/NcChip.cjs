require('../assets/NcChip-BNLuZgd6.css');
"use strict";
const Vue = require("vue");
const _l10n = require("../chunks/_l10n-DINju8Lo.cjs");
const NcActions = require("../chunks/NcActions-C_gPnk6X.cjs");
const NcActionButton = require("../chunks/NcActionButton-ChQFsL4S.cjs");
...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    const realVariant = Vue.computed(() => props.type !== "secondary" ? props.type : props.variant);
    ...
    return { __sfc: true, props, emit, slots, realVariant, canClose, hasActions, hasIcon, onClose, mdiClose, NcActions: NcActions.NcActions, NcActionButton: NcActionButton.NcActionButton, NcIconSvgWrapper: NcIconSvgWrapper.NcIconSvgWrapper };
  }
};
var _sfc_render = function render() {
  ...
  })], 2), _setup.canClose || _setup.hasActions() ? _c(_setup.NcActions, { staticClass: "nc-chip__actions", attrs: { "force-menu": !_setup.canClose, "variant": "tertiary-no-background" } }, [_setup.canClose ? _c(_setup.NcActionButton, { attrs: { "close-after-click": "" }, on: { "click": _setup.onClose }, scopedSlots: _vm._u([{ key: "icon", fn: function() {
...
//# sourceMappingURL=NcChip.cjs.map
