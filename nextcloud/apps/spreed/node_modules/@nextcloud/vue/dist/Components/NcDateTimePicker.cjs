require('../assets/NcDateTimePicker-BmtdlJm4.css');
"use strict";
const _l10n = require("../chunks/_l10n-ICucobx3.cjs");
...
const ScopeComponent = require("../chunks/ScopeComponent-B1fKsMww.cjs");
