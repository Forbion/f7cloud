...
const _pluginVue2_normalizer = require("./chunks/_plugin-vue2_normalizer-B8VAeAQS.cjs");
...
class FilePicker {
   ...
   */
  async pick() {
    const { FilePickerVue } = await Promise.resolve().then(() => require("./chunks/index-1sMM4CmY.cjs"));
