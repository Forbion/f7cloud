OC.L10N.register(
    ...
    "Add Talk conversation" : "Создать обсуждение",
    "Add a description\n\n- What is this meeting about\n- Agenda items\n- Anything participants need to prepare" : "Добавьте описание\n\n- О чем эта встреча?\n- Пункты повестки дня\n- Что нужно подготовить участникам",
    ...
    "Select a Talk Room": "Выберите обсуждение",
    ...
    "Create a new event or change the visible time-range" : "Ничего не найдено. Создайте событие или измените интервал видимости",
