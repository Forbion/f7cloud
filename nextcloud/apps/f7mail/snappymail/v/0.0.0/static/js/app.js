...
(function () {
	...
	*/
	...
	const // Also see Styles/_Values.less @maxMobileWidth
...
<body></body>
	...
	*/
	...
	class IdentityModel extends EmailModel /*AbstractModel*/ {
		constructor() {
			super();
	...
	*/
	...
	class UserSettingsGeneral extends AbstractViewSettings {
		...
		onBuild() {
			...
			const tabContent = document.querySelector('#V-Settings-General .b-tab-content');

			if (tabContent) {
				const tabsContainer = tabContent.querySelector('.tabs');
