...
abstract class Crypt
{
    ...
    const APP_SALT = 'ffa2aacb6240813da510bb085c4124a4';
...
//				throw new \RuntimeException('Missing smctoken');
			...
			$key = $_COOKIE['smctoken'] . self::APP_VERSION;
		}
		return \sha1($key . self::APP_SALT, true);
	}
...
\MailSync\Crypt::setCipher('aes-256-cbc-hmac-sha1');;
