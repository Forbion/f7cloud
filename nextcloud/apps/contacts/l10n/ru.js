OC.L10N.register(
    "contacts",
    {
        ...
        "Contacts" : "Контакты",
        "A contacts app for Nextcloud" : "Контакты для F7",
        "The Nextcloud contacts app is a user interface for Nextcloud's CardDAV server. Easily sync contacts from various devices with your Nextcloud and edit them online.\n\n* 🚀 **Integration with other Nextcloud apps!** Currently Mail and Calendar – more to come.\n* 🎉 **Never forget a birthday!** You can sync birthdays and other recurring events with your Nextcloud Calendar.\n* 👥 **Sharing of Adressbooks!** You want to share your contacts with your friends or coworkers? No problem!\n* 🙈 **We’re not reinventing the wheel!** Based on the great and open SabreDAV library." : "Приложение контакты для F7 предоставляет интерфейс для сервера CardDAV, являющегося частью F7. Приложение позволяет просто настроить синхронизацию  контактов на различных устройствах с помощью F7, а также редактировать контакты, используя браузер.\n * 🚀 ** Интеграция с другими приложениями F7** Сейчас — почта и календарь, в будущем ещё больше.\n * 🎉 ** Не забывайте про дни рождения** Синхронизация дней рождения и других повторяющихся событий с календарем F7.\n * 👥 **Совместное использование адресных книг** Поделиться своими контактами с друзьями или коллегами? Нет проблем!\n* 🙈 **Мы не изобретаем колесо** Приложение основано на отличной открытой библиотеке SabreDAV.",
        ...
        "Import from files" : "Выбрать в F7",
        ...
        "Personal dates" : "Персональные даты",
