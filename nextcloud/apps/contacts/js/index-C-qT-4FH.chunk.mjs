...
const g = (n) => "/remote.php/" + n, U = (n, e) => {
  var o;
  return ((o = void 0) != null ? o : w()) + g(n);
}, v = (n, e, o) => {
  var c;
...
export {
  ...
  shallowRef as X,
  onRequestTokenUpdate as Y,
  _,
  getDefaultExportFromCjs$1 as a,
  cancelableClient as b,
  commonjsGlobal as c,
  ...
  toRaw as t,
  unsubscribe as u,
  vue_runtime_esm as v,
  watch as w,
  set as x,
  reactive as y,
  isRef as z
};
//# sourceMappingURL=index-C-qT-4FH.chunk.mjs.map
