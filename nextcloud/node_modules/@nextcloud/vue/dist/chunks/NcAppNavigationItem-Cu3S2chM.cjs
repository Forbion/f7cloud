require('../assets/NcAppNavigationItem-DKcGNjYx.css');
"use strict";
const NcActions = require("./NcActions-B76VN_Gz.cjs");
const NcActionButton = require("./NcActionButton-D_9FsTpM.cjs");
...
const NcInputConfirmCancel = require("./NcInputConfirmCancel-Dz7-CkOl.cjs");
...
_l10n.register(_l10n.t20, _l10n.t49);
const _sfc_main$2 = {
  name: "PencilIcon",
  emits: ["click"],
  props: {
...
var _sfc_render = function render4() {
  ...
  return _c("li", { staticClass: "app-navigation-entry-wrapper", class: {
    ...
    }, proxy: true }], null, true) }) : _vm._e(), _vm._t("actions")], 2) : _vm._e()], 1) : _vm._e(), _vm.isCollapsible() ? _c("NcAppNavigationIconCollapsible", { attrs: { "active": isActive && _vm.to || _vm.active, "open": _vm.opened }, on: { "click": function($event) {
      $event.preventDefault();
...
//# sourceMappingURL=NcAppNavigationItem-Cu3S2chM.cjs.map
