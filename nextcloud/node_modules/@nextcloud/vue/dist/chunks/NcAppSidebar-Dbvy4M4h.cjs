...
const _sfc_main = {
  ...
  components: {
    ...
    NcAppSidebarHeader: NcAppSidebarHeader.NcAppSidebarHeader,
    NcAppSidebarTabs,
  ...
  setup() {
    ...
    Vue.provide("NcAppSidebar:header:ref", headerRef);
    return {
  ...
  methods: {
    ...
    focus() {
      ...
      try {
        ...
        Vue__default.default.util.warn("NcAppSidebar should have focusable header for accessibility reasons. Use NcAppSidebarHeader component.");
      }
    },
    /**
...
//# sourceMappingURL=NcAppSidebar-Dbvy4M4h.cjs.map
