require('../assets/NcPopover--XoXIhLx.css');
"use strict";
...
floatingVue.options.themes[THEME] = structuredClone(floatingVue.options.themes.dropdown);
const _sfc_main = {
  name: "NcPopover",
  components: {
...
//# sourceMappingURL=NcPopover-QGSKWhSP.cjs.map
