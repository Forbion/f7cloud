require('../assets/NcModal-Cy3UOuI2.css');
"use strict";
const ScopeComponent = require("../chunks/ScopeComponent-CTlekHht.cjs");
...
const focusTrap = require("../chunks/focusTrap-DUTqW_IG.cjs");
...
//# sourceMappingURL=NcModal.cjs.map
