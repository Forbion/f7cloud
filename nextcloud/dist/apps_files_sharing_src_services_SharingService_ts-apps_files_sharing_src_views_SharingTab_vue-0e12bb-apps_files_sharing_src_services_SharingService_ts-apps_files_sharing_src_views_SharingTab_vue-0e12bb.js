...
/* harmony import */ var _services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/WebdavClient.ts */ "./apps/files_sharing/src/services/WebdavClient.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    async getNode() {
      ...
      try {
        this.node = await (0,_services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_4__.fetchNode)(node);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    title() {
      ...
      } else if (this.share.type === _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_0__.ShareType.Remote) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
     ...
     */
    isEmailShareType() {
      return this.share ? this.share.type === _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_3__.ShareType.Email : false;
    },
     ...
     */
    externalLinkActions() {
      const filterValidAction = action => (action.shareType.includes(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_3__.ShareType.Link) || action.shareType.includes(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_3__.ShareType.Email)) && !action.advanced;
  ...
  methods: {
    ...
    async onNewLinkShare() {
      ...
      const shareDefaults = {
        share_type: _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_3__.ShareType.Link
      };
    ...
    async pushNewLinkShare(share, update) {
      try {
        ...
        const options = {
          path,
          shareType: _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_3__.ShareType.Link,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    async getSuggestions(search) {
      ...
      const shareType = [_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.User, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.Group, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.Remote, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.RemoteGroup, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.Team, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.Room, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.Guest, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.Deck, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_9__.ShareType.ScienceMesh];
...
/* harmony import */ var _mixins_SharesMixin_js__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../mixins/SharesMixin.js */ "./apps/files_sharing/src/mixins/SharesMixin.js");
/* harmony import */ var _services_logger_ts__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../services/logger.ts */ "./apps/files_sharing/src/services/logger.ts");
/* harmony import */ var _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../lib/SharePermissionsToolBox.js */ "./apps/files_sharing/src/lib/SharePermissionsToolBox.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_ShareRequests_js__WEBPACK_IMPORTED_MODULE_27__["default"], _mixins_SharesMixin_js__WEBPACK_IMPORTED_MODULE_28__["default"]],
  props: {
    shareRequestValue: {
      type: Object,
      required: false
  ...
  data() {
    return {
      ...
      sharingPermission: _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.BUNDLED_PERMISSIONS.ALL.toString(),
      revertSharingPermission: _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.BUNDLED_PERMISSIONS.ALL.toString(),
      setCustomPermissions: false,
      passwordError: false,
      advancedSectionAccordionExpanded: false,
      bundledPermissions: _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.BUNDLED_PERMISSIONS,
  ...
  computed: {
    ...
    customPermissionsList() {
      ...
      const translatedPermissions = {
        [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.READ]: this.t('files_sharing', 'Read'),
        [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.CREATE]: this.t('files_sharing', 'Create'),
        [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.UPDATE]: this.t('files_sharing', 'Edit'),
        [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.SHARE]: this.t('files_sharing', 'Share'),
        [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.DELETE]: this.t('files_sharing', 'Delete')
      };
      return [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.READ, _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.CREATE, _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.UPDATE, ...(this.resharingIsPossible ? [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.SHARE] : []), _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.DELETE].filter(permission => (0,_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.hasPermissions)(this.share.permissions, permission)).map((permission, index) => index === 0 ? translatedPermissions[permission] : translatedPermissions[permission].toLocaleLowerCase((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.getLanguage)())).join(', ');
    },
  ...
  beforeMount() {
    ...
    _services_logger_ts__WEBPACK_IMPORTED_MODULE_29__["default"].debug('Share object received', {
      share: this.share
    });
    _services_logger_ts__WEBPACK_IMPORTED_MODULE_29__["default"].debug('Configuration object received', {
      config: this.config
    });
  },
  mounted() {
  ...
  methods: {
    updateAtomicPermissions() {
      ...
      const permissions = 0 | (isReadChecked ? _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.READ : 0) | (isCreateChecked ? _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.CREATE : 0) | (isDeleteChecked ? _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.DELETE : 0) | (isEditChecked ? _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.UPDATE : 0) | (isReshareChecked ? _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.ATOMIC_PERMISSIONS.SHARE : 0);
    ...
    handleDefaultPermissions() {
      if (this.isNewShare) {
        ...
        if (defaultPermissions === _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.BUNDLED_PERMISSIONS.READ_ONLY || defaultPermissions === _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.BUNDLED_PERMISSIONS.ALL) {
    ...
    async saveShare() {
      ...
      if (!this.isFolder && this.share.permissions === _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.BUNDLED_PERMISSIONS.ALL) {
        // It's not possible to create an existing file.
        this.share.permissions = _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_30__.BUNDLED_PERMISSIONS.ALL_FILE;
      }
      ...
      if (this.isNewShare) {
        ...
        (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_0__.emit)('update:share', this.share);
    ...
    async addShare(share) {
      _services_logger_ts__WEBPACK_IMPORTED_MODULE_29__["default"].debug('Adding a new share from the input for', {
        share
      });
      ...
      try {
        ...
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_29__["default"].error('Error while adding new share', {
          error
        });
      } finally {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
     ...
     */
    hasLinkShares() {
      return this.shares.filter(share => share.type === _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_4__.ShareType.Link).length > 0;
    },
    /**
...
/* harmony import */ var _mixins_ShareDetails_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mixins/ShareDetails.js */ "./apps/files_sharing/src/mixins/ShareDetails.js");
/* harmony import */ var _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @nextcloud/sharing */ "./node_modules/@nextcloud/sharing/dist/index.mjs");
// eslint-disable-next-line no-unused-vars
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_ShareDetails_js__WEBPACK_IMPORTED_MODULE_1__["default"]],
  props: {
    fileInfo: {
      type: Object,
      default: () => {},
    ...
    isUnique() {
      return share => {
        return [...this.shares].filter(item => {
          return share.type === _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.User && share.shareWithDisplayName === item.shareWithDisplayName;
        }).length <= 1;
      };
    }
  }
...
/* harmony import */ var _nextcloud_vue_dist_Components_NcAvatar_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcAvatar.js */ "./node_modules/@nextcloud/vue/dist/Components/NcAvatar.mjs");
/* harmony import */ var _services_ConfigService_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../services/ConfigService.ts */ "./apps/files_sharing/src/services/ConfigService.ts");
/* harmony import */ var _utils_SharedWithMe_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/SharedWithMe.js */ "./apps/files_sharing/src/utils/SharedWithMe.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'SharingTab',
  components: {
    NcAvatar: _nextcloud_vue_dist_Components_NcAvatar_js__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  data() {
    return {
      config: new _services_ConfigService_ts__WEBPACK_IMPORTED_MODULE_7__["default"](),
      deleteEvent: null,
      error: '',
  ...
  methods: {
    ...
    processShares(_ref) {
      ...
      if (data.ocs && data.ocs.data && data.ocs.data.length > 0) {
        const shares = (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.orderBy)(data.ocs.data.map(share => new _models_Share_ts__WEBPACK_IMPORTED_MODULE_9__["default"](share)), [
        ...
        this.linkShares = shares.filter(share => share.type === _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_5__.ShareType.Link || share.type === _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_5__.ShareType.Email);
        this.shares = shares.filter(share => share.type !== _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_5__.ShareType.Link && share.type !== _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_5__.ShareType.Email);
    ...
    processSharedWithMe(_ref2) {
      ...
      if (data.ocs && data.ocs.data && data.ocs.data[0]) {
        const share = new _models_Share_ts__WEBPACK_IMPORTED_MODULE_9__["default"](data);
        const title = (0,_utils_SharedWithMe_js__WEBPACK_IMPORTED_MODULE_8__.shareWithTitle)(share);
...
var render = function render() {
  ...
  return _c("li", {
    ...
    on: {
      ...
      change: _vm.onExpirationDateToggleChange
    }
    ...
    on: {
      change: function ($event) {
        return _vm.expirationDateChanged($event);
      }
    },
    scopedSlots: _vm._u([{
      key: "icon",
...
//# sourceMappingURL=apps_files_sharing_src_services_SharingService_ts-apps_files_sharing_src_views_SharingTab_vue-0e12bb-apps_files_sharing_src_services_SharingService_ts-apps_files_sharing_src_views_SharingTab_vue-0e12bb.js.map?v=a828d393f9a6562fa542