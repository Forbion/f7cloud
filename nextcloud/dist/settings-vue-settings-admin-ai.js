...
var render = function render() {
  ...
  return _c("div", {
    ...
    model: {
      value: _vm.settings["ai.taskprocessing_guests"],
      callback: function ($$v) {
        _vm.$set(_vm.settings, "ai.taskprocessing_guests", $$v);
      },
      expression: "settings['ai.taskprocessing_guests']"
    }
  }, [_vm._v("\n\t\t\t" + _vm._s(_vm.t("settings", "Allow AI usage for guest users")) + "\n\t\t")]), _vm._v(" "), _vm._l(_vm.taskProcessingTaskTypes, function (type) {
    return [_c("div", {
      key: type
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-ai.js.map?v=14fff50b7dee9cfdd4d8