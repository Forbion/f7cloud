...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_2__["default"].extend({
  ...
  computed: {
    userCount() {
      if (this.loading) {
        return this.n('settings', '{userCount} аккаунта …', '{userCount} аккаунтов …', this.filteredUsers.length, {
    ...
    async updateDisplayName() {
      ...
      try {
        ...
        if (this.editedDisplayName === this.user.displayname) {
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__.showSuccess)(t('setting', 'Успешно изменено'));
        }
      } finally {
...
//# sourceMappingURL=settings-users-settings-users.js.map?v=f884a9a118f07b4d701b