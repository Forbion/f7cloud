...
/* harmony export */   getGuestNameValidity: () => (/* binding */ getGuestNameValidity)
/* harmony export */ });
...
function getGuestNameValidity(name) {
  ...
  if (name.startsWith('.')) {
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files', 'Names must not start with a dot.');
  }
  try {
    ...
    switch (error.reason) {
      case _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.InvalidFilenameErrorReason.Character:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files', '"{char}" is not allowed inside a name.', {
          char: error.segment
        }, undefined, {
          escape
        });
      case _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.InvalidFilenameErrorReason.ReservedName:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files', '"{segment}" is a reserved name and not allowed.', {
      ...
      case _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.InvalidFilenameErrorReason.Extension:
        if (error.segment.match(/\.[a-z]/i)) {
          return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files', '"{extension}" is not an allowed name.', {
            extension: error.segment
          }, undefined, {
            escape: false
          });
        }
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files', 'Names must not end with "{extension}".', {
          extension: error.segment
        }, undefined, {
          escape: false
        });
      default:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files', 'Invalid name.');
    }
  }
}
...
/* harmony import */ var _services_GuestNameValidity__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/GuestNameValidity */ "./apps/files_sharing/src/services/GuestNameValidity.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_6__.defineComponent)({
  ...
  setup() {
    return {
      ...
      owner: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('files_sharing', 'owner', ''),
      ownerDisplayName: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('files_sharing', 'ownerDisplayName', ''),
      label: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('files_sharing', 'label', ''),
      note: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('files_sharing', 'note', ''),
      filename: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('files_sharing', 'filename', '')
    };
  },
  data() {
    return {
  ...
  computed: {
    ...
    dialogButtons() {
      return [{
        label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'Submit name'),
        type: 'primary',
        nativeType: 'submit'
      }];
    }
  ...
  watch: {
    ...
    name() {
      ...
      const validity = (0,_services_GuestNameValidity__WEBPACK_IMPORTED_MODULE_5__.getGuestNameValidity)(newName);
...
//# sourceMappingURL=apps_files_sharing_src_views_PublicAuthPrompt_vue-apps_files_sharing_src_views_PublicAuthPrompt_vue.js.map?v=2fd3a326c663970f280e