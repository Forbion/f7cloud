...
/* harmony import */ var _services_logger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/logger */ "./apps/files_sharing/src/services/logger.ts");
/**
...
const storage = (0,_nextcloud_browser_storage__WEBPACK_IMPORTED_MODULE_0__.getBuilder)('files_sharing').build();
/**
...
function registerFileRequestHeader(nickname) {
  ...
  _services_logger__WEBPACK_IMPORTED_MODULE_4__["default"].debug('Nickname header registered for uploader', {
...
window.addEventListener('DOMContentLoaded', () => {
  const nickname = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_1__.getGuestNickname)() ?? '';
  ...
  if (!nickname || !dialogShown) {
    (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.spawnDialog)((0,vue__WEBPACK_IMPORTED_MODULE_5__.defineAsyncComponent)(() => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("apps_files_sharing_src_views_PublicAuthPrompt_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./views/PublicAuthPrompt.vue */ "./apps/files_sharing/src/views/PublicAuthPrompt.vue"))), {
      nickname
    }, onSetNickname);
  } else {
    _services_logger__WEBPACK_IMPORTED_MODULE_4__["default"].debug('Public auth prompt already shown.', {
      nickname
    });
    registerFileRequestHeader(nickname);
  }
...
/******/ })()
;
//# sourceMappingURL=files_sharing-public-file-request.js.map?v=fe363df3d85be32445dc