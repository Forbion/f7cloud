...
/* harmony import */ var _utils_xhr_request_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/xhr-request.js */ "./core/src/utils/xhr-request.js");
...
const query = query_string__WEBPACK_IMPORTED_MODULE_9__["default"].parse(location.search);
if (query.clear === '1') {
  (0,_utils_xhr_request_js__WEBPACK_IMPORTED_MODULE_8__.wipeBrowserStorages)();
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'Login',
  components: {
...
.password-less-login-form[data-v-34bf48f7] label {
  text-align: initial;
}
...
/******/ })()
;
//# sourceMappingURL=core-login.js.map?v=f83d4c0f7535bab70780