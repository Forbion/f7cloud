    ...
    async toggleStarred(state) {
      try {
        ...
        const node = new Node({
          ...
          source: `${_nextcloud_files__WEBPACK_IMPORTED_MODULE_4__.davRemoteURL}${_nextcloud_files__WEBPACK_IMPORTED_MODULE_4__.davRootPath}${this.file}`,
          root: _nextcloud_files__WEBPACK_IMPORTED_MODULE_4__.davRootPath,
          mime: isDir ? undefined : this.fileInfo.mimetype,
          attributes: {
            favorite: 1
          }
        });
        (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_3__.emit)(state ? 'files:favorites:added' : 'files:favorites:removed', node);
        this.fileInfo.isFavourited = state;
      } catch (error) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__.showError)(t('files', 'Unable to change the favorite state of the file'));
        _logger_ts__WEBPACK_IMPORTED_MODULE_19__["default"].error('Unable to change favorite state', {
          error
        });
      }
    },
...
/******/ })()
;
//# sourceMappingURL=files-sidebar.js.map?v=65e7de753bd39e0233ff