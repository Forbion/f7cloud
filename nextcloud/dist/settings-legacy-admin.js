...
window.addEventListener('DOMContentLoaded', () => {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('#loglevel').change(function () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default().post(OC.generateUrl('/settings/admin/log/level'), {
  ...
  const setupChecks = () => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default().when(OC.SetupChecks.checkSetup()).then(messages => {
      ...
      if (hasMessages) {
        ...
        const securityWarning = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#security-warning');
...
/******/ })()
;
//# sourceMappingURL=settings-legacy-admin.js.map?v=770d6b030727f5f0bad6