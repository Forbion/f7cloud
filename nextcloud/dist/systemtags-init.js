...
function mix(color1, color2, factor) {
  ...
  return new (color__WEBPACK_IMPORTED_MODULE_0___default())(color2).mix(new (color__WEBPACK_IMPORTED_MODULE_0___default())(color1), (factor + 100) / 200).hex();
}
/**
...
function lighten(color, factor) {
  ...
  return new (color__WEBPACK_IMPORTED_MODULE_0___default())(color).lighten((factor + 100) / 200).hex();
}
/**
...
function darken(color, factor) {
  ...
  return new (color__WEBPACK_IMPORTED_MODULE_0___default())(color).darken((factor + 100) / 200).hex();
}
/**
...
function hexToRGB(color) {
  return new (color__WEBPACK_IMPORTED_MODULE_0___default())(color).rgb().array();
}
/**
...
function hexToHSL(color) {
  const hsl = new (color__WEBPACK_IMPORTED_MODULE_0___default())(color).hsl();
  return {
    h: hsl.color[0],
    s: hsl.color[1],
    l: hsl.color[2]
...
function hslToHex(hsl) {
  return new (color__WEBPACK_IMPORTED_MODULE_0___default())(hsl).hex();
}
/**
 * Convert RGB color to hex
 * @param r red
...
/******/ })()
;
//# sourceMappingURL=systemtags-init.js.map?v=a8e17d7af0e101b0a945