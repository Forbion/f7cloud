...
(0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_2__.addPasswordConfirmationInterceptors)(_nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
function initApplicableUsersMultiselect($elements, userListLimit) {
  ...
  return $elements.select2({
    placeholder: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Type to select account or group.'),
    allowClear: true,
    multiple: true,
    toggleSelect: true,
    ...
    formatSelection(element) {
      if (element.type === 'group') {
        return '<span title="' + escapeHTML(element.name) + '" class="group">' + escapeHTML(element.displayname + ' ' + (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', '(Group)')) + '</span>';
      } else {
...
StorageConfig.prototype = {
  ...
  async _save(method, url, options) {
    try {
      const response = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].request({
  ...
  async destroy(options) {
    ...
    try {
      await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].request({
        method: 'DELETE',
        url: OC.generateUrl(this._url + '/{id}', {
          id: this.id
        }),
...
MountOptionsDropdown.prototype = {
  ...
  show($container, mountOptions, visibleOptions) {
    ...
    const $el = $(OCA.Files_External.Templates.mountOptionsDropDown({
      mountOptionsEncodingLabel: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Compatibility with Mac NFD encoding (slow)'),
      mountOptionsEncryptLabel: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Enable encryption'),
      mountOptionsPreviewsLabel: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Enable previews'),
      mountOptionsSharingLabel: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Enable sharing'),
      mountOptionsFilesystemCheckLabel: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Check for changes'),
      mountOptionsFilesystemCheckOnce: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Never'),
      mountOptionsFilesystemCheckDA: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Once every direct access'),
      mountOptionsReadOnlyLabel: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Read only'),
      deleteLabel: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Disconnect')
    }));
    this.$el = $el;
...
MountConfigListView.prototype = _.extend({
  ...
  _onSelectBackend(event) {
    ...
    const onCompletion = jquery__WEBPACK_IMPORTED_MODULE_3___default().Deferred();
  ...
  newStorage(storageConfig, onCompletion, deferAppend) {
    ...
    if (backend.invalid || backend.identifier === 'local' && !this._canCreateLocal) {
      ...
      $tr.find('.save').empty();
      if (backend.invalid) {
        this.updateStatus($tr, false, (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Unknown backend: {backendName}', {
        ...
        success(result) {
          ...
          result.forEach(function (storageParams) {
            ...
            if (isUserGlobal) {
              ...
              $tr.find('.configuration').text((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Admin defined'));
            }
            ...
            if (result.length < 20) {
              ...
              self.updateStatus($tr, StorageConfig.Status.INDETERMINATE, (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Automatic status checking is disabled due to the large number of configured storages, click to check status'));
            }
            $rows = $rows.add($tr);
          });
  ...
  deleteStorageConfig($tr) {
    ...
    OC.dialogs.confirm((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Are you sure you want to disconnect this external storage? It will make the storage unavailable in Nextcloud and will lead to a deletion of these files and folders on any sync client that is currently connected but will not delete any files and folders on the external storage itself.', {
      storage: this.mountPoint
    }), (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Delete storage?'), function (confirm) {
      if (confirm) {
  ...
  updateStatus($tr, status, message) {
    ...
    if (typeof message !== 'string') {
      message = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Click to recheck the configuration');
    }
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  $allowUserMounting.bind('change', function () {
    ...
    OC.msg.finishedSaving('#userMountingMsg', {
      status: 'success',
      data: {
        message: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Saved')
      }
    });
  });
  ...
  $('#global_credentials').on('submit', async function (event) {
    ...
    $submit.val((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Saving …'));
    ...
    $submit.val((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Saved'));
    setTimeout(function () {
      $submit.val((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_external', 'Save'));
    }, 2500);
    return false;
  });
...
/******/ })()
;
//# sourceMappingURL=files_external-settings.js.map?v=2d8a050db038629a7301