...
/* harmony import */ var _files_trashbin_src_files_views_trashbinView_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../files_trashbin/src/files_views/trashbinView.ts */ "./apps/files_trashbin/src/files_views/trashbinView.ts");
/* harmony import */ var _deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./deleteUtils.ts */ "./apps/files/src/actions/deleteUtils.ts");
...
const queue = new p_queue__WEBPACK_IMPORTED_MODULE_4__["default"]({
  concurrency: 5
});
const ACTION_DELETE = 'delete';
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.FileAction({
  id: ACTION_DELETE,
  displayName: _deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.displayName,
  iconSvgInline: nodes => {
    if ((0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.canUnshareOnly)(nodes)) {
      return _mdi_svg_svg_close_svg_raw__WEBPACK_IMPORTED_MODULE_5__;
    }
    if ((0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.canDisconnectOnly)(nodes)) {
  ...
  enabled(nodes, view) {
    if (view.id === _files_trashbin_src_files_views_trashbinView_ts__WEBPACK_IMPORTED_MODULE_8__.TRASHBIN_VIEW_ID) {
  ...
  async exec(node, view) {
    try {
      ...
      if (!(0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.isTrashbinEnabled)() || isCalledFromEventListener) {
        confirm = await (0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.askConfirmation)([node], view);
      }
      ...
      await (0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.deleteNode)(node);
      return true;
    } catch (error) {
      _logger_ts__WEBPACK_IMPORTED_MODULE_10__["default"].error('Error while deleting a file', {
        error,
        source: node.source,
        node
      });
  ...
  async execBatch(nodes, view) {
    let confirm = true;
    // If trashbin is disabled, we need to ask for confirmation
    if (!(0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.isTrashbinEnabled)()) {
      confirm = await (0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.askConfirmation)(nodes, view);
    } else if (nodes.length >= 5 && !(0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.canUnshareOnly)(nodes) && !(0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.canDisconnectOnly)(nodes)) {
      confirm = await (0,_deleteUtils_ts__WEBPACK_IMPORTED_MODULE_9__.askConfirmation)(nodes, view);
    }
    // If the user cancels the deletion, we don't want to do anything
    if (confirm === false) {
...
/* harmony import */ var _mdi_svg_svg_star_outline_svg_raw__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @mdi/svg/svg/star-outline.svg?raw */ "./node_modules/@mdi/svg/svg/star-outline.svg?raw");
/* harmony import */ var _mdi_svg_svg_star_svg_raw__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @mdi/svg/svg/star.svg?raw */ "./node_modules/@mdi/svg/svg/star.svg?raw");
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../logger.ts */ "./apps/files/src/logger.ts");
...
const favoriteNode = async (node, view, willFavorite) => {
  try {
    ...
    _logger_ts__WEBPACK_IMPORTED_MODULE_10__["default"].error('Error while ' + action, {
      error,
      source: node.source,
      node
    });
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.FileAction({
  ...
  iconSvgInline: nodes => {
    return shouldFavorite(nodes) ? _mdi_svg_svg_star_outline_svg_raw__WEBPACK_IMPORTED_MODULE_8__ : _mdi_svg_svg_star_svg_raw__WEBPACK_IMPORTED_MODULE_9__;
  },
  enabled(nodes) {
      ...
      const promise = new Promise(resolve => {
        queue.add(async () => {
          try {
            ...
            _logger_ts__WEBPACK_IMPORTED_MODULE_10__["default"].error('Error while adding file to favorite', {
              error,
              source: node.source,
              node
            });
...
const entry = {
  ...
  iconSvgInline: _mdi_svg_svg_folder_plus_svg_raw__WEBPACK_IMPORTED_MODULE_7__.replace(/viewBox/gi, 'style="color: var(--color-primary-element)" viewBox'),
  order: 0,
...
const useFilesStore = function () {
  const store = (0,pinia__WEBPACK_IMPORTED_MODULE_4__.defineStore)('files', {
    state: () => ({
      files: {},
      roots: {}
    }),
    ...
    actions: {
      ...
      getNodesByPath(service, path) {
        const pathsStore = (0,_paths_ts__WEBPACK_IMPORTED_MODULE_3__.usePathsStore)();
        let folder;
      ...
      updateNodes(nodes) {
        ...
        vue__WEBPACK_IMPORTED_MODULE_5__["default"].set(this, 'files', {
          ...this.files,
          ...files
        });
      },
      deleteNodes(nodes) {
        nodes.forEach(node => {
          if (node.source) {
            vue__WEBPACK_IMPORTED_MODULE_5__["default"].delete(this.files, node.source);
          }
        });
      },
      setRoot(_ref) {
        ...
        vue__WEBPACK_IMPORTED_MODULE_5__["default"].set(this.roots, service, root);
      },
      onDeletedNode(node) {
      ...
      onMovedNode(_ref2) {
        ...
        vue__WEBPACK_IMPORTED_MODULE_5__["default"].delete(this.files, oldSource);
        this.updateNodes([node]);
      },
      async onUpdatedNode(node) {
        ...
        (0,_services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_2__.fetchNode)(node.path).then(n => this.updateNodes([n]));
      },
      // Handlers for legacy sidebar (no real nodes support)
      onAddFavorite(node) {
        const ourNode = this.getNode(node.source);
        if (ourNode) {
          vue__WEBPACK_IMPORTED_MODULE_5__["default"].set(ourNode.attributes, 'favorite', 1);
        }
      },
      onRemoveFavorite(node) {
        const ourNode = this.getNode(node.source);
        if (ourNode) {
          vue__WEBPACK_IMPORTED_MODULE_5__["default"].set(ourNode.attributes, 'favorite', 0);
        }
      }
    }
  });
...
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../logger */ "./apps/files/src/logger.ts");
/* harmony import */ var _files__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./files */ "./apps/files/src/store/files.ts");
...
const usePathsStore = function () {
  const files = (0,_files__WEBPACK_IMPORTED_MODULE_4__.useFilesStore)(...arguments);
  const store = (0,pinia__WEBPACK_IMPORTED_MODULE_5__.defineStore)('paths', {
    state: () => ({
      paths: {}
    }),
    getters: {
    ...
    actions: {
      addPath(payload) {
        ...
        if (!this.paths[payload.service]) {
          vue__WEBPACK_IMPORTED_MODULE_6__["default"].set(this.paths, payload.service, {});
        }
        // Now we can set the provided path
        vue__WEBPACK_IMPORTED_MODULE_6__["default"].set(this.paths[payload.service], payload.path, payload.source);
      },
      deletePath(service, path) {
        ...
        vue__WEBPACK_IMPORTED_MODULE_6__["default"].delete(this.paths[service], path);
      },
      onCreatedNode(node) {
        const service = (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.getNavigation)()?.active?.id || 'files';
        if (!node.fileid) {
          _logger__WEBPACK_IMPORTED_MODULE_3__["default"].error('Node has no fileid', {
            node
          });
          return;
        }
      ...
      deleteNodeFromParentChildren(node) {
        ...
        const parentSource = (0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_0__.dirname)(node.source);
        ...
        if (folder) {
          ...
          vue__WEBPACK_IMPORTED_MODULE_6__["default"].set(folder, '_children', [...children.values()]);
          _logger__WEBPACK_IMPORTED_MODULE_3__["default"].debug('Children updated', {
            parent: folder,
            node,
        ...
        _logger__WEBPACK_IMPORTED_MODULE_3__["default"].debug('Parent path does not exists, skipping children update', {
          node
        });
      },
  ...
  if (!pathsStore._initialized) {
    (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_2__.subscribe)('files:node:created', pathsStore.onCreatedNode);
    (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_2__.subscribe)('files:node:deleted', pathsStore.onDeletedNode);
    (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_2__.subscribe)('files:node:moved', pathsStore.onMovedNode);
...
/******/ })()
;
//# sourceMappingURL=files-init.js.map?v=d61b5b39efe54964a043