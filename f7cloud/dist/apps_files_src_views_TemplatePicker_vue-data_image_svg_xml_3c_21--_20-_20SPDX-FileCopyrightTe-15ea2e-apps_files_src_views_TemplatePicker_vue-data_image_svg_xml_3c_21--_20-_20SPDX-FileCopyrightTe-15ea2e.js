...
/* harmony export */   getTemplateFields: () => (/* binding */ getTemplateFields),
...
const getTemplateFields = async function (fileId) {
  const response = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__.generateOcsUrl)(`apps/files/api/v1/templates/fields/${fileId}`));
  return response.data.ocs.data;
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_13__.defineComponent)({
  ...
  methods: {
    ...
    onConfirmClick(fileid) {
      if (fileid === this.checked) {
        this.onSubmit();
      }
    },
    async createFile() {
      let templateFields = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    async onSubmit() {
      ...
      if (fileId && fileId !== this.emptyTemplate.fileid) {
        fields = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_7__.getTemplateFields)(fileId);
      }
      if (fields.length > 0) {
...
var render = function render() {
  ...
  return _c("NcModal", {
    attrs: {
      "label-id": "template-field-modal__label"
    }
  }, [_c("div", {
    staticClass: "template-field-modal__content"
  }, [_c("form", [_c("h3", {
    attrs: {
      id: "template-field-modal__label"
    }
  }, [_vm._v("\n\t\t\t\t" + _vm._s(_vm.t("files", "Fill template fields")) + "\n\t\t\t")]), _vm._v(" "), _vm._l(_vm.fields, function (field) {
    return _c("div", {
      key: field.index
    }, [_vm.fieldHasLabel(field) ? _c(_vm.getFieldComponent(field.type), {
      tag: "component",
      attrs: {
        field: field
      },
...
var render = function render() {
  ...
  return _vm.opened ? _c("NcModal", {
    ...
    on: {
      "confirm-click": _vm.onConfirmClick,
      check: _vm.onCheck
    }
...
//# sourceMappingURL=apps_files_src_views_TemplatePicker_vue-data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightTe-15ea2e-apps_files_src_views_TemplatePicker_vue-data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightTe-15ea2e.js.map?v=a087f9ebed6f9312f083