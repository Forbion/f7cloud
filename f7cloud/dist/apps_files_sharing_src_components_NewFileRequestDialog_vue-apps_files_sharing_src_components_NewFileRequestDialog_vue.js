...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_10__.defineComponent)({
  ...
  computed: {
    ...
    isExpirationDateEnforced() {
      ...
      return this.defaultExpireDateEnabled && this.defaultExpireDateEnforced;
    },
    isPasswordEnforced() {
      // Both fields needs to be enabled in the settings
      return this.enableLinkPasswordByDefault && this.enforcePasswordForPublicLink;
    }
  },
  mounted() {
  ...
  methods: {
    ...
    onPasteEmails(e) {
      ...
      if (duplicateEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.n)('files_sharing', '{count} email address already added', '{count} email addresses already added', duplicateEmails.length, {
          count: duplicateEmails.length
        }));
      }
      if (validEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.n)('files_sharing', '{count} email address added', '{count} email addresses added', validEmails.length, {
...
var render = function render() {
  ...
  return _c("div", [_vm.passwordAndExpirationSummary ? _c("NcNoteCard", {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: !_vm.isExpirationDateEnforced,
      expression: "!isExpirationDateEnforced"
    }],
    attrs: {
      checked: _vm.isExpirationDateEnforced || _vm.expirationDate !== null,
      disabled: _vm.disabled || _vm.isExpirationDateEnforced
    },
    on: {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: !_vm.isPasswordEnforced,
      expression: "!isPasswordEnforced"
    }],
    attrs: {
      checked: _vm.isPasswordEnforced || _vm.password !== null,
      disabled: _vm.disabled || _vm.isPasswordEnforced
    },
    on: {
    ...
    attrs: {
      ...
      required: _vm.enforcePasswordForPublicLink,
      value: _vm.password,
      name: "password"
    },
    on: {
...
//# sourceMappingURL=apps_files_sharing_src_components_NewFileRequestDialog_vue-apps_files_sharing_src_components_NewFileRequestDialog_vue.js.map?v=1b28b6bd4effe4525353