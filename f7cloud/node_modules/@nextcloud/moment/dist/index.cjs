...
if (locale === "en") {
  moment__default.default.updateLocale(moment__default.default.locale(), {
    relativeTime: { s: "seconds" }
  });
}
if (locale in translations) {
  const gt = gettext.getGettextBuilder().setLanguage(locale).addTranslation(locale, translations[locale]).build();
  moment__default.default.updateLocale(moment__default.default.locale(), {
    relativeTime: {
