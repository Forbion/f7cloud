require('../assets/NcChip-CF4Q149V.css');
"use strict";
const mdi = require("../chunks/mdi-B_QN3oas.cjs");
const Vue = require("vue");
const _l10n = require("../chunks/_l10n-RKohWu5d.cjs");
const NcActions = require("../chunks/NcActions-B76VN_Gz.cjs");
const NcActionButton = require("../chunks/NcActionButton-D_9FsTpM.cjs");
...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    return { __sfc: true, props, emit, slots, realVariant, canClose, hasActions, hasIcon, onClose, mdiClose: mdi.mdiClose, NcActions: NcActions.NcActions, NcActionButton: NcActionButton.NcActionButton, NcIconSvgWrapper: NcIconSvgWrapper.NcIconSvgWrapper };
  }
};
