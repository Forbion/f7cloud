require('../assets/NcMentionBubble-UsTMm5VD.css');
require('../assets/NcAvatar-BqNcvkxP.css');
"use strict";
...
const _sfc_main = {
  ...
  components: {
    IconDotsHorizontal: NcActions.DotsHorizontalIcon,
  ...
  setup() {
    const isDarkTheme = Composables_useIsDarkTheme.useIsDarkTheme();
    return {
      isDarkTheme
    };
  },
...
//# sourceMappingURL=NcAvatar-DThzrxm-.cjs.map
