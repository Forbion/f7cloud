...
require('../assets/NcHeaderMenu-Cjb3kKi1.css');
"use strict";
...
require("../Composables/useIsDarkTheme.cjs");
require("@nextcloud/router");
require("../Functions/isDarkTheme.cjs");
;/* empty css                                                                           */
...
const _sfc_main = {
  ...
  setup(props) {
    const opened = Vue.ref(props.open);
    useTrapStackControl.useTrapStackControl(opened, {
...
//# sourceMappingURL=NcHeaderMenu-BWFubuox.cjs.map
