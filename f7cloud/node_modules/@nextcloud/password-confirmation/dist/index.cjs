...
const NcLoadingIcon = require("@nextcloud/vue/dist/Components/NcLoadingIcon.js");
const NcPasswordField = require("@nextcloud/vue/dist/Components/NcPasswordField.js");
...
const NcPasswordField__default = /* @__PURE__ */ _interopDefault(NcPasswordField);
/*!
...
const _sfc_main = vue.defineComponent({
  ...
  components: {
    ...
    NcLoadingIcon: NcLoadingIcon__default.default,
    NcPasswordField: NcPasswordField__default.default
  },
  props: {
    validate: {
      type: Function,
...
async function _confirmPassword(password) {
  ...
  const url = router.generateUrl("/login/confirm");
  const { data } = await axios__default.default.post(url, { password });
...
function getDialog() {
  ...
  if (window._nc_password_confirmation_dialog === void 0) {
    ...
    const dialog = dialogs.spawnDialog(PasswordDialogVue, {}, () => {
    });
          ...
          async (password) => {
            ...
            switch (config.confirmPassword) {
              ...
              case PwdConfirmationMode.Strict:
                ...
                config.auth = {
                  username: (_b = (_a = auth.getCurrentUser()) == null ? void 0 : _a.uid) != null ? _b : "",
                  password
                };
                resolve(config);
...
exports.PwdConfirmationMode = PwdConfirmationMode;
exports.addPasswordConfirmationInterceptors = addPasswordConfirmationInterceptors;
exports.confirmPassword = confirmPassword;
exports.isPasswordConfirmationRequired = isPasswordConfirmationRequired;
