...
const NcCheckboxRadioSwitch = require("@nextcloud/vue/components/NcCheckboxRadioSwitch");
...
const NcDateTime = require("@nextcloud/vue/components/NcDateTime");
const js = require("@mdi/js");
const sharing = require("@nextcloud/sharing");
const PQueue = require("p-queue");
const NcIconSvgWrapper = require("@nextcloud/vue/components/NcIconSvgWrapper");
const NcActions = require("@nextcloud/vue/components/NcActions");
const NcActionInput = require("@nextcloud/vue/components/NcActionInput");
const NcBreadcrumbs = require("@nextcloud/vue/components/NcBreadcrumbs");
const NcBreadcrumb = require("@nextcloud/vue/components/NcBreadcrumb");
const auth = require("@nextcloud/auth");
const NcSelect = require("@nextcloud/vue/components/NcSelect");
...
const NcEmptyContent = require("@nextcloud/vue/components/NcEmptyContent");
const cancelablePromise = require("cancelable-promise");
const path = require("path");
const _interopDefault = (e) => e && e.__esModule ? e : { default: e };
const NcButton__default = /* @__PURE__ */ _interopDefault(NcButton);
const NcCheckboxRadioSwitch__default = /* @__PURE__ */ _interopDefault(NcCheckboxRadioSwitch);
const axios__default = /* @__PURE__ */ _interopDefault(axios);
const NcDateTime__default = /* @__PURE__ */ _interopDefault(NcDateTime);
...
const NcActionInput__default = /* @__PURE__ */ _interopDefault(NcActionInput);
const NcBreadcrumbs__default = /* @__PURE__ */ _interopDefault(NcBreadcrumbs);
const NcBreadcrumb__default = /* @__PURE__ */ _interopDefault(NcBreadcrumb);
const NcSelect__default = /* @__PURE__ */ _interopDefault(NcSelect);
const NcTextField__default = /* @__PURE__ */ _interopDefault(NcTextField);
const NcDialog__default = /* @__PURE__ */ _interopDefault(NcDialog);
const NcEmptyContent__default = /* @__PURE__ */ _interopDefault(NcEmptyContent);
const _sfc_main$e = {
  name: "FileIcon",
  emits: ["click"],
  props: {
...
var __component__$e = /* @__PURE__ */ _pluginVue2_normalizer.normalizeComponent(
  _sfc_main$e,
  _sfc_render$e,
  ...
  vue.onMounted(async () => {
    if (!_public.isPublicShare()) {
      try {
        ...
        _pluginVue2_normalizer.showError(_pluginVue2_normalizer.t("Could not load files settings"));
      }
    } else {
  ...
  vue.onMounted(async () => {
    if (!_public.isPublicShare()) {
      try {
        ...
        _pluginVue2_normalizer.showError(_pluginVue2_normalizer.t("Could not load files views"));
      }
    } else {
...
var __component__$d = /* @__PURE__ */ _pluginVue2_normalizer.normalizeComponent(
  _sfc_main$d,
  _sfc_render$d,
...
var __component__$c = /* @__PURE__ */ _pluginVue2_normalizer.normalizeComponent(
  _sfc_main$c,
  _sfc_render$c,
...
var __component__$b = /* @__PURE__ */ _pluginVue2_normalizer.normalizeComponent(
  _sfc_main$b,
  _sfc_render$b,
...
const usePreviewURL = (node, options) => {
  ...
  vue.watchEffect(() => {
    ...
    if (previewURL.value && core.toValue(node).type === files.FileType.File) {
...
var __component__$a = /* @__PURE__ */ _pluginVue2_normalizer.normalizeComponent(
  _sfc_main$a,
  _sfc_render$a,
...
const _sfc_main$9 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const folderDecorationIcon = vue.computed(() => {
      ...
      if (shareTypes.some((type) => type === sharing.ShareType.Link || type === sharing.ShareType.Email)) {
        return js.mdiLink;
      }
      if (shareTypes.length > 0) {
        return js.mdiAccountPlus;
      }
      switch (props.node.attributes?.["mount-type"]) {
        case "external":
        case "external-session":
          return js.mdiNetwork;
        case "group":
          return js.mdiGroup;
        case "shared":
          return js.mdiAccountPlus;
    ...
    return { __sfc: true, fileListIconStyles, props, previewURL, previewLoaded, isFile, folderDecorationIcon, NcIconSvgWrapper: NcIconSvgWrapper__default.default, IconFile, IconFolder };
  }
});
...
const _sfc_main$8 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return { __sfc: true, props, emit, displayName, fileExtension, isDirectory, isPickable, toggleSelected, handleClick, handleKeyDown, formatFileSize: files.formatFileSize, NcCheckboxRadioSwitch: NcCheckboxRadioSwitch__default.default, NcDateTime: NcDateTime__default.default, t: _pluginVue2_normalizer.t, FilePreview };
  }
});
...
const _sfc_main$7 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return { __sfc: true, props, emit, customSortingConfig, filesAppSorting, sortingConfig, sortByName, sortBySize, sortByModified, toggleSorting, sortFavoritesFirst, cropImagePreviews, sortedFiles, selectableFiles, allSelected, onSelectAll, onNodeSelected, onChangeDirectory, skeletonNumber, fileContainer, NcButton: NcButton__default.default, NcCheckboxRadioSwitch: NcCheckboxRadioSwitch__default.default, t: _pluginVue2_normalizer.t, IconSortAscending, IconSortDescending, LoadingTableRow, FileListRow };
  }
});
...
const _sfc_main$4 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    function validateInput() {
      ...
      let validity = "";
      if (name.length === 0) {
        validity = _pluginVue2_normalizer.t("Folder name cannot be empty.");
      } else if (name.includes("/")) {
        validity = _pluginVue2_normalizer.t('"/" is not allowed inside a folder name.');
      } else if (["..", "."].includes(name)) {
        validity = _pluginVue2_normalizer.t('"{name}" is an invalid folder name.', { name });
      } else if (window.OC.config?.blacklist_files_regex && name.match(window.OC.config?.blacklist_files_regex)) {
        validity = _pluginVue2_normalizer.t('"{name}" is not an allowed folder name', { name });
      }
      if (input) {
    ...
    return { __sfc: true, props, emit, actionsOpen, newNodeName, nameInput, validateInput, onSubmit, pathElements, IconFolder, IconHome, IconPlus, NcActions: NcActions__default.default, NcActionInput: NcActionInput__default.default, NcBreadcrumbs: NcBreadcrumbs__default.default, NcBreadcrumb: NcBreadcrumb__default.default, t: _pluginVue2_normalizer.t };
  }
});
...
const useViews = (isAnonymous) => {
  const allViews = [
    {
      id: "files",
      label: _pluginVue2_normalizer.t("All files"),
      icon: js.mdiFolder
    },
    {
      id: "recent",
      label: _pluginVue2_normalizer.t("Recent"),
      icon: js.mdiClock
    },
    {
      id: "favorites",
      label: _pluginVue2_normalizer.t("Favorites"),
      icon: js.mdiStar
    }
  ];
...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return { __sfc: true, props, emit, availableViews, currentViewObject, updateFilterValue, IconClose, IconMagnify, NcButton: NcButton__default.default, NcIconSvgWrapper: NcIconSvgWrapper__default.default, NcSelect: NcSelect__default.default, NcTextField: NcTextField__default.default, Fragment: vueFrag.Fragment, t: _pluginVue2_normalizer.t };
  }
});
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const viewHeadline = vue.computed(() => currentView.value === "favorites" ? _pluginVue2_normalizer.t("Favorites") : currentView.value === "recent" ? _pluginVue2_normalizer.t("Recent") : "");
    ...
    const noFilesDescription = vue.computed(() => {
      if (currentView.value === "files") {
        return _pluginVue2_normalizer.t("Upload some content or sync with your devices!");
      } else if (currentView.value === "recent") {
        return _pluginVue2_normalizer.t("Files and folders you recently modified will show up here.");
      } else {
        return _pluginVue2_normalizer.t("Files and folders you mark as favorite will show up here.");
      }
    });
    const onCreateFolder = async (name) => {
      try {
        ...
        _pluginVue2_normalizer.showError(_pluginVue2_normalizer.t("Could not create the new folder"));
      }
    };
    ...
    return { __sfc: true, props, emit, isOpen, dialogButtons, isHandlingCallback, handleButtonClick, currentView, viewHeadline, selectedFiles, savedPath, navigatedPath, currentPath, filterString, isSupportedMimeType, files: files2, currentFolder, isLoading, loadFiles, createDirectory, showHiddenFiles, filteredFiles, noFilesDescription, onCreateFolder, handleClose, IconFile, FileList, FilePickerBreadcrumbs, FilePickerNavigation, NcDialog: NcDialog__default.default, NcEmptyContent: NcEmptyContent__default.default, t: _pluginVue2_normalizer.t };
  }
});
...
//# sourceMappingURL=FilePicker-pf241QhF.cjs.map
