...
const _pluginVue2_normalizer = require("./chunks/_plugin-vue2_normalizer-MxS9rO0K.cjs");
...
class FilePicker {
   ...
   */
  async pickNodes() {
    const { FilePickerVue } = await Promise.resolve().then(() => require("./chunks/index-BfE5XwAp.cjs"));
    return new Promise((resolve, reject) => {
      dialog.spawnDialog(FilePickerVue, {
...
const spawnDialog = dialog.spawnDialog;
...
class Dialog {
  ...
  async show() {
    ...
    return new Promise((resolve) => {
      this.#dialog = dialog.spawnDialog(
        GenericDialog,
        {
          buttons: this.#buttons,
          name: this.#name,
...
function showGuestUserPrompt(props) {
  return new Promise((resolve) => {
    dialog.spawnDialog(
      vue.defineAsyncComponent(() => Promise.resolve().then(() => require("./chunks/PublicAuthPrompt-P1AJteoi.cjs"))),
      props,
      resolve
    );
  });
...
exports.showGuestUserPrompt = showGuestUserPrompt;
